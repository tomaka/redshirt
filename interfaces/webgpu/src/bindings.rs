...
pub const WGPUBackendType_WGPUBackendType_D3D11: WGPUBackendType = 0;
pub const WGPUBackendType_WGPUBackendType_D3D12: WGPUBackendType = 1;
pub const WGPUBackendType_WGPUBackendType_Metal: WGPUBackendType = 2;
pub const WGPUBackendType_WGPUBackendType_Vulkan: WGPUBackendType = 3;
pub const WGPUBackendType_WGPUBackendType_OpenGL: WGPUBackendType = 4;
pub const WGPUBackendType_WGPUBackendType_OpenGLES: WGPUBackendType = 5;
...
pub struct WGPUAdapterDescriptor {
    pub nextInChain: *const ::core::ffi::c_void,
}
#[test]
...
fn bindgen_test_layout_WGPUBindGroupLayoutBinding() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUBindGroupLayoutBinding>())).multisampled as *const _ as usize
        },
        13usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPUCommandBufferDescriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUCommandBufferDescriptor>())).nextInChain as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPUComputePassDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUComputePassDescriptor>())).label as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUComputePassDescriptor),
...
fn bindgen_test_layout_WGPUCreateBufferMappedResult() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUCreateBufferMappedResult>())).dataLength as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPUFenceDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUFenceDescriptor>())).nextInChain as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPURenderBundleEncoderDescriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPURenderBundleEncoderDescriptor>())).label as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPURenderPassDepthStencilAttachmentDescriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPURenderPassDepthStencilAttachmentDescriptor>())).stencilLoadOp
                as *const _ as usize
        },
        20usize,
        concat!(
...
fn bindgen_test_layout_WGPUSamplerDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUSamplerDescriptor>())).magFilter as *const _ as usize },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUSamplerDescriptor),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUSamplerDescriptor>())).minFilter as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUSamplerDescriptor),
...
fn bindgen_test_layout_WGPUShaderModuleDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUShaderModuleDescriptor>())).code as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUShaderModuleDescriptor),
...
fn bindgen_test_layout_WGPUSurfaceDescriptorFromMetalLayer() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromMetalLayer>())).nextInChain as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromMetalLayer>())).sType as *const _
                as usize
        },
        8usize,
        concat!(
...
fn bindgen_test_layout_WGPUSurfaceDescriptorFromWindowsHwnd() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromWindowsHwnd>())).nextInChain as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromWindowsHwnd>())).sType as *const _
                as usize
        },
        8usize,
        concat!(
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct WGPUSurfaceDescriptorFromWindowsXlib {
    pub nextInChain: *const ::core::ffi::c_void,
    pub sType: WGPUSType,
...
#[test]
fn bindgen_test_layout_WGPUSurfaceDescriptorFromWindowsXlib() {
    assert_eq!(
        ::core::mem::size_of::<WGPUSurfaceDescriptorFromWindowsXlib>(),
        32usize,
        concat!(
            "Size of: ",
            stringify!(WGPUSurfaceDescriptorFromWindowsXlib)
        )
    );
    assert_eq!(
        ::core::mem::align_of::<WGPUSurfaceDescriptorFromWindowsXlib>(),
        8usize,
        concat!(
            "Alignment of ",
            stringify!(WGPUSurfaceDescriptorFromWindowsXlib)
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromWindowsXlib>())).nextInChain as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromWindowsXlib>())).sType as *const _
                as usize
        },
        8usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromWindowsXlib>())).display as *const _
                as usize
        },
        16usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUSurfaceDescriptorFromWindowsXlib>())).window as *const _
                as usize
        },
        24usize,
        concat!(
...
fn bindgen_test_layout_WGPUTextureViewDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUTextureViewDescriptor>())).label as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUTextureViewDescriptor),
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUTextureViewDescriptor>())).mipLevelCount as *const _ as usize
        },
        28usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPUColorStateDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUColorStateDescriptor>())).format as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUColorStateDescriptor),
...
fn bindgen_test_layout_WGPUDepthStencilStateDescriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUDepthStencilStateDescriptor>())).stencilWriteMask as *const _
                as usize
        },
        56usize,
        concat!(
...
fn bindgen_test_layout_WGPUTextureCopyView() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUTextureCopyView>())).nextInChain as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPUTextureDescriptor() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<WGPUTextureDescriptor>())).dimension as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(WGPUTextureDescriptor),
...
fn bindgen_test_layout_WGPUVertexStateDescriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPUVertexStateDescriptor>())).vertexBuffers as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_WGPURenderPipelineDescriptor() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<WGPURenderPipelineDescriptor>())).sampleMask as *const _ as usize
        },
        112usize,
        concat!(
            "Offset of field: ",
...
pub type WGPUFenceOnCompletionCallback = ::core::option::Option<
    unsafe extern "C" fn(status: WGPUFenceCompletionStatus, userdata: *mut ::core::ffi::c_void),
>;
pub type WGPURequestAdapterCallback = ::core::option::Option<
    unsafe extern "C" fn(result: WGPUAdapter, userdata: *mut ::core::ffi::c_void),
>;
pub type WGPURequestDeviceCallback = ::core::option::Option<
    unsafe extern "C" fn(result: WGPUDevice, userdata: *mut ::core::ffi::c_void),
>;
...
pub type WGPUProcGetProcAddress = ::core::option::Option<
    unsafe extern "C" fn(device: WGPUDevice, procName: *const c_char) -> WGPUProc,
>;
...
>;
pub type WGPUProcTextureDestroy = ::core::option::Option<unsafe extern "C" fn(texture: WGPUTexture)>;
extern "C" {
    pub fn wgpuCreateInstance(descriptor: *const WGPUInstanceDescriptor) -> WGPUInstance;
}
extern "C" {
    pub fn wgpuGetProcAddress(
        device: WGPUDevice,
