...
fn resolve_moves_in_block<F: Function>(
    ...
    let mut block_ends = HashSet::<_, BuildHasherDefault<FxHasher>>::default();
    let mut block_starts = HashSet::<_, BuildHasherDefault<FxHasher>>::default();
    ...
    let mut reloads_at_inst = HashMap::<_, _, BuildHasherDefault<FxHasher>>::default();
...
fn resolve_moves_across_blocks<F: Function>(
    ...
    let mut parallel_move_map = HashMap::<_, _, BuildHasherDefault<FxHasher>>::default();

    let block_info = collect_block_infos(func, intervals, liveins, liveouts);

    let mut seen_successors = HashSet::<_, BuildHasherDefault<FxHasher>>::default();
